// Start of patch
import PouchDB from 'pouchdb';  // This is necessary, otherwise we get error

// To make this plugin work with PouchDB 6.x.x, we used this pull request:
// https://github.com/MazeMap/Leaflet.TileLayer.PouchDBCached/pull/32
