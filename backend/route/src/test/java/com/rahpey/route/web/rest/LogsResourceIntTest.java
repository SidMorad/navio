...
import com.rahpey.route.config.SecurityBeanOverrideConfiguration;
import com.rahpey.route.web.rest.vm.LoggerVM;
...
@SpringBootTest(classes = {RouteApp.class, SecurityBeanOverrideConfiguration.class})
