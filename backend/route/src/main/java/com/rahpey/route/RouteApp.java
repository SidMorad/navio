package com.rahpey.route;

import com.rahpey.route.client.OAuth2InterceptedFeignConfiguration;
import com.rahpey.route.config.ApplicationProperties;
import com.rahpey.route.config.DefaultProfileUtil;
...
public class RouteApp {
    ...
    public RouteApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RouteApp.class);
