package com.rahpey.traffic;

import com.rahpey.traffic.client.OAuth2InterceptedFeignConfiguration;
import com.rahpey.traffic.config.ApplicationProperties;
import com.rahpey.traffic.config.DefaultProfileUtil;
...
public class TrafficApp {
    ...
    public TrafficApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TrafficApp.class);
